...
export type ExerciseLogExerciseQueryVariables = Exact<{
  exerciseId: Scalars['ID'];
}>;


export type ExerciseLogExerciseQuery = { __typename?: 'Query', exercise: { __typename?: 'Exercise', id: string, name: string } };
